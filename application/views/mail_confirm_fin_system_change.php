                                ...
                                <tr>
                                    <td align="center" style="vertical-align:middle;">
										...
										<p style="font-size:16px; font-family:Arial, Helvetica, sans-serif; color:#fff; padding-top:15px;">
											<?php echo lang('mail_body_fin_system_change_1'); ?>
											<br/><br/>
											<?php
												if(isset($ok_pay_wallet) && trim($ok_pay_wallet) != '')
												{
													echo lang('okpay_wallet').":\t\t\t<b>$ok_pay_wallet</b>";
													echo "<br/><br/>";
												}
												if(isset($pm_wallet) && trim($pm_wallet) != '')
												{
													echo lang('pm_wallet').":\t\t\t<b>$pm_wallet</b>";
													echo "<br/><br/>";
												}
											?>
											<?php echo lang('mail_body_fin_system_change_2'); ?>
											<a href="<?php echo base_url('/fin_system/confirm_system_change/'.$special_part); ?>"><?php echo base_url('/fin_system/confirm_system_change/'.$special_part); ?></a>
											<br/><br/>
											<?php echo lang('mail_body_fin_system_change_3'); ?>
											<br/><br/>
											<a href="<?php echo base_url('/fin_system/cancel_system_change_request/'.$special_part); ?>"><?php echo base_url('/fin_system/cancel_system_change_request/'.$special_part); ?></a>
										</p>
									</td>
                                </tr>
                            </table>
