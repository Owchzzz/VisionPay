<?php $this->load->view('header'); ?>
	...
	<div class="section_page">
		<?php
			...
			{
				case 'success':
					echo '<div style="font-weight:bold;color:#0000FF;">'.$msg_text.'</div>';
					break;
					
				case 'fail':
					echo '<div style="font-weight:bold;color:#FF0000;">'.$msg_text.'</div>';
					break;
					
				case 'info':
					echo '<div style="font-weight:bold;color:#0000FF;">'.$msg_text.'</div>';
					break;
			}// end of switch(strtolower($message_type))
		?>
	</div>
