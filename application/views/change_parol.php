<?php $this->load->view('header'); ?>
	...
	<div class="div_lang">
		...
		<div class="article_head">
			<h1><?php echo lang('change_your_password');?></h1>
		</div>
	</div>
	<div class="section_page_big">
		<?php $this->load->view('left_menu'); ?>
		<div class="art_cab_right">
			<form action="/user/change_password" method="post" name="frm_change_password" id="frm_change_password">
			
				<?php echo validation_errors(); ?>
				<?php echo $form_submit_message; ?>
			<!--
				<label><?php echo lang('login_sponsor');?><span>*</span></label>
				<input type="text" value="" />
			-->
				<label><?php echo lang('current_password');?><span>*</span></label>
				...
				<label><?php echo lang('repeat_new_password');?><span>*</span></label>
			...
			<!--
				...
				<em><?php echo lang('letter_sent_with_a_link');?>!</em>
			-->
			</div>
		</div>
	</div>
...
<script>
	$(document).ready(function(){
		$("#frm_change_password").validationEngine('attach');
	   });
</script>
