                                ...
                                <tr>
                                    <td align="center" style="vertical-align:middle;">
										...
										<p style="font-size:16px; font-family:Arial, Helvetica, sans-serif; color:#fff; padding-top:15px;">
											<?php echo lang('mail_body_forgot_password_1'); ?>
											<br/><br/>
											<a href="<?php echo base_url('/user/reset_password/'.$special_part); ?>"><?php echo base_url('/user/reset_password/'.$special_part); ?></a>
											<br/><br/>
											<?php echo lang('mail_body_forgot_password_2'); ?>
											<br/><br/>
											<a href="<?php echo base_url('/user/cancel_reset_password/'.$special_part); ?>"><?php echo base_url('/user/cancel_reset_password/'.$special_part); ?></a>
										</p>
									</td>
                                </tr>
                            </table>
