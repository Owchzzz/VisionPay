...
<?php $this->load->view('header'); ?>
	...
	<div class="section_page_big">
		...
		<p class="p_login"><?php echo lang('login');?>: <span><?php echo $logged_in_user; ?></span><br />
<?php
...
?>
		...
		<ul>
			<li><span><?php if(array_key_exists(0, $my_pyramid)) echo "<a href='http://visionclab.com/matrix/m1_other?login=".$my_pyramid[0]."'>".$my_pyramid[0]."</a>"; ?></span><?php 
if(array_key_exists(0, $my_pyramid)){
		$sponsor=get_sponsor($my_pyramid[0]);
		echo "<a href='http://visionclab.com/matrix/m1_other?login=$sponsor'>".$sponsor."</a>"; 
}	
		?></li>
		</ul>
		<ul>
			<li><span><?php if(array_key_exists(1, $my_pyramid)) echo "<a href='http://visionclab.com/matrix/m1_other?login=".$my_pyramid[1]."'>".$my_pyramid[1]."</a>"; ?></span><?php 
if(array_key_exists(1, $my_pyramid)){
		$sponsor=get_sponsor($my_pyramid[1]);
		echo "<a href='http://visionclab.com/matrix/m1_other?login=$sponsor'>".$sponsor."</a>"; 
} ?></li>
			<li><span><?php if(array_key_exists(2, $my_pyramid)) echo "<a href='http://visionclab.com/matrix/m1_other?login=".$my_pyramid[2]."'>".$my_pyramid[2]."</a>"; ?></span><?php 
...
?></li>
		...
		<ul>
			<li><span><?php if(array_key_exists(3, $my_pyramid)) echo "<a href='http://visionclab.com/matrix/m1_other?login=".$my_pyramid[3]."'>".$my_pyramid[3]."</a>"; ?></span><?php 
				if(array_key_exists(3, $my_pyramid)){
		$sponsor=get_sponsor($my_pyramid[3]);
		echo "<a href='http://visionclab.com/matrix/m1_other?login=$sponsor'>".$sponsor."</a>"; 
}
				?></li>
			<li><span><?php if(array_key_exists(4, $my_pyramid)) echo "<a href='http://visionclab.com/matrix/m1_other?login=".$my_pyramid[4]."'>".$my_pyramid[4]."</a>"; ?></span><?php 
if(array_key_exists(4, $my_pyramid)){
		$sponsor=get_sponsor($my_pyramid[4]);
		echo "<a href='http://visionclab.com/matrix/m1_other?login=$sponsor'>".$sponsor."</a>"; 
}
				?></li>
			<li><span><?php if(array_key_exists(5, $my_pyramid)) echo "<a href='http://visionclab.com/matrix/m1_other?login=".$my_pyramid[5]."'>".$my_pyramid[5]."</a>"; ?></span><?php 
				if(array_key_exists(5, $my_pyramid)){
		$sponsor=get_sponsor($my_pyramid[5]);
		echo "<a href='http://visionclab.com/matrix/m1_other?login=$sponsor'>".$sponsor."</a>"; 
}
				?></li>
			<li><span><?php if(array_key_exists(6, $my_pyramid)) echo "<a href='http://visionclab.com/matrix/m1_other?login=".$my_pyramid[6]."'>".$my_pyramid[6]."</a>"; ?></span><?php 
