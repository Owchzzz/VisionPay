                                ...
                                <tr>
                                    <td align="center" style="vertical-align:middle;">
										...
										<p style="font-size:16px; font-family:Arial, Helvetica, sans-serif; color:#fff; padding-top:15px;">
											<?php echo lang('mail_body_fin_password_change_1'); ?>
											<br/><br/>
											<a href="<?php echo base_url('/fin_system/confirm_password_change/'.$special_part); ?>"><?php echo base_url('/fin_system/confirm_password_change/'.$special_part); ?></a>
											<br/><br/>
											<?php echo lang('mail_body_fin_password_change_2'); ?>
											<br/><br/>
											<a href="<?php echo base_url('/fin_system/cancel_password_change_request/'.$special_part); ?>"><?php echo base_url('/fin_system/cancel_password_change_request/'.$special_part); ?></a>
										</p>
									</td>
                                </tr>
                            </table>
